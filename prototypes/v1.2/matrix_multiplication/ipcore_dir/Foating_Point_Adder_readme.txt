The following files were generated for 'Foating_Point_Adder' in directory
...
Generate XCO file:
   ...
   * Foating_Point_Adder.xco

C Simulation Generator:
   Please see the core data sheet.

   * Foating_Point_Adder/cmodel/floating_point_v6_1_bitacc_cmodel_lin.zip
   * Foating_Point_Adder/cmodel/floating_point_v6_1_bitacc_cmodel_lin64.zip
   * Foating_Point_Adder/cmodel/floating_point_v6_1_bitacc_cmodel_nt.zip
   * Foating_Point_Adder/cmodel/floating_point_v6_1_bitacc_cmodel_nt64.zip

Generate EJava outputs:
   Please see the core data sheet.

   * demo_tb/tb_Foating_Point_Adder.vhd

Generate Implementation Netlist:
   Binary Xilinx implementation netlist files containing the information
   required to implement the module in a Xilinx (R) FPGA.

   * Foating_Point_Adder.ngc
...
Deliver IP Symbol:
   ...
   * Foating_Point_Adder.asy

SYM file generator:
   Generate a SYM file for compatibility with legacy flows

   * Foating_Point_Adder.sym
...
Generate XMDF file:
   ...
   * Foating_Point_Adder_xmdf.tcl

Generate ISE project file:
   ISE Project Navigator support files. These are generated files and should not
   be edited directly.

   * Foating_Point_Adder.gise
   * Foating_Point_Adder.xise
   * _xmsgs/pn_parser.xmsgs

Deliver Readme:
   Readme file for the IP.

   * Foating_Point_Adder_readme.txt

Generate FLIST file:
   Text file listing all of the output files produced when a customized core was
   generated in the CORE Generator.

   * Foating_Point_Adder_flist.txt
